...
export function UploadSection() {
  ...
  const getUploadDescription = () => {
    switch (uploadType) {
      case 'pdf':
        return 'Upload study materials, assignments, and educational PDFs'
      case 'image':
        return 'Upload diagrams, charts, and visual learning materials'
      case 'notice':
        return 'Create and publish announcements for your students'
      default:
        return 'Upload educational content'
    }
  }
